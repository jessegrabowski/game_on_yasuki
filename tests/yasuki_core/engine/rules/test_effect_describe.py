...
EFFECTS = [
    ...
    (InterruptWindow((Bow("farm_1"),)), "interrupt window over 1 effects"),
    ...
    (
        LookAtTop(PlayerId.P1, DeckKey(PlayerId.P1, Side.FATE), 4),
    ...
    (
        Arrange(PlayerId.P1, ("a", "b"), "put_back_on_top", "src"),
        "P1 orders 2 for the top for put_back_on_top",
    ),
