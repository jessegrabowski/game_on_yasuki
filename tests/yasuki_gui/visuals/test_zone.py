...
def test_a_province_card_picked_for_a_decision_is_ringed(root):
    ...
    card = L5RCard.of(CardPrint, id="z9", name="Z9", side=Side.DYNASTY)
...
def test_an_unpicked_province_card_keeps_its_ordinary_border(root):
    ...
    card = L5RCard.of(CardPrint, id="z8", name="Z8", side=Side.DYNASTY)
...
def test_zone_draw_with_top_card_front_and_back(root):
    ...
    c1 = L5RCard.of(CardPrint, id="z1", name="Z1", side=Side.DYNASTY)
    ...
    c2 = L5RCard.of(CardPrint, id="z2", name="Z2", side=Side.DYNASTY)
    c2.turn_face_down()
    zv2 = ZoneVisual(
