...
class ImageProvider:
    ...
    def front(self, image_front: Path | str | None, bowed: bool) -> Any | None:
        return load_image(image_front, bowed, master=self.master)
    ...
    def back(
        ...
        return load_back_image(side, bowed, image_back, master=self.master)
